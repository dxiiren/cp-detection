...
system needs: not just "a paste happened" but *how* it was triggered (Ctrl+V, right-click menu, or
drag-drop) and *who* triggered it (a real user or a script). It is built with TanStack Start
